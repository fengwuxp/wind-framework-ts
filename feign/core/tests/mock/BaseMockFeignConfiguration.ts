...
import {HttpResponseEventPublisher, SmartHttpResponseEventListener} from '../../src/event/HttpResponseEvent';
 ...
 */
export class BaseMockFeignConfiguration implements FeignHttpConfiguration {

 ...
 */
type MethodInterceptor = (object: any, propertyKey: PropertyKey, receiver: any) => MethodProxy | any;
type MethodProxy = (...args: any[]) => any;
/**
 * 属性拦截
 * @param object       被拦截的对象
 * @param propertyKey  被拦截的属性
 ...
 * @return  是否设置成功
 */
type SetPropertyInterceptor = (object: any, propertyKey: PropertyKey, value: any, receiver: any) => boolean;
...
type CustomMatchType<T = any> = (object: any, propertyKey: string) => boolean | RegExp;
